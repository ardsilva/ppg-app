...
import { StyledButtons, StyledCard, StyledContainer, StyledList, StyledListElement } from './styled';
...
export function ShowDetails() {
  ...
  const handleGetEpisodes = async () => {
    try {
      const response = await (await fetch(`https://api.tvmaze.com/shows/1955/episodes`)).json()
  ...
  return (
    <StyledContainer>
      ...
      <StyledButtons>
        {!episodes && <Button handleClick={handleGetEpisodes} text='Get Episodes' />}
